...
Galleria.addTheme({
    ...
    init: function(options) {
        ...
        this.bind('loadfinish', function(e) {
            // HAX: add anchor tag around image and title
            this.$('info-title').each(function () {
                $(this).wrapInner('<a href="' + e.galleriaData.link + '" />');
             });

            $('.galleria-image img').each(function () {
                $(this).wrap('<a href="' + e.galleriaData.link + '" />');
            });
